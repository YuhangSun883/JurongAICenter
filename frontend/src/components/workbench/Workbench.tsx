...
export function Workbench() {
  ...
  const [referencePreview, setReferencePreview] = useState<ReferenceMedia | null>(null);
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#f7f7f8] px-4 py-5 text-[#16181d] sm:px-6">
                ...
                selectedReferences.map((reference, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        setSelectedReferences((current) => current.filter((item) => item.id !== reference.id));
                      }}
      ...
      {/* 参考素材预览弹窗(图片/视频/音频) — 点击已选缩略图时全屏播放 */}
