...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
        ...
        if (token != null) {
            try {
                ...
                UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(
                    new AuthenticatedUser(userId, email, effectiveRole, channel == null ? "APP" : channel),
                    null,
    ...
    public record AuthenticatedUser(Long id, String email, String role, String channel) {}
}
